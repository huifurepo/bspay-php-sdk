...
function get9c3eba3dFfd748adBd72B5c5a7d14166() {
    $dto = array();
    // 签约人类型
    // $dto["type"] = "test";
...
function getDca60be3B35a47579e015437a4b7150f() {
    $dto = array();
    // 联系人身份证号码
...
function get747ad3adB92949449bbe159bf7dceac5() {
    $dto = array();
    // 证件持有人类型
    // $dto["legal_type"] = "";
    // 证件类型
...
function get3d360edd04f34d6b8755Daeed989f864() {
    $dto = array();
    // 是否金融机构
...
function getF99012caE5f347f7Badb203ee11d48a4() {
    $dto = array();
    // 支付场景
    $dto["pay_scene"] = "1";
    // 手续费（%）
...
function get1d43c2c1A2eb4dd98d481a9d31a9e663() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function get13d84123Cbf54a1d819cDef4073b19fe() {
    $dto = array();
    // 申请类型
    // $dto["apply_type"] = "test";
    // 商户支付宝账号
...
function getC1eadb3aCba24f2aAb0eA94f46e23e4a() {
    $dto = array();
...
function getE5b7937c965a49abA713Da35b24d6a17() {
    $dto = array();
    // 支付场景
    $dto["pay_scene"] = "1";
    // 手续费（%）
...
function get3c31c4b2D2c94dc8B9ceC9a833dc509d() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function get7e08d9944bc74bed888a4fc77a837b29() {
    $dto = array();
    // 联系人类型
...
function getB21fe2d67c614bdc8778373835209e68() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function getF22a55ae32214990A740Ed129830d2a1() {
    $dto = array();
    // 证件类型
...
function get65ec12d085d1461e8731Ab03bc7500b4() {
    $dto = array();
    // 经营者/法人是否为受益人
    // $dto["ubo_type"] = "test";
...
function getF0905d36Cd914818A7a9F0f3f4cca398() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function get2a2249c077ac45c995d5538564b91c74() {
    $dto = array();
    // 经营场景类型
...
function get130db66e91d34e73893e6ce551406f77() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function getEf3375bb0ab34affAe438f29795cf02b() {
    $dto = array();
    // 登记证书类型
    // $dto["cert_type"] = "test";
    // 证书号
...
function get2dd035c1Ab584ab384a6F9cdb4f251a9() {
    $dto = array();
    // 账户类型
    // $dto["card_type"] = "test";
    // 开户名称
...
function getAb0a8b7a79eb4e77947dFa26b74e1bb9() {
    $dto = array();
    // 申请服务
...
function get48ce636b58944922A804A4d80d1a61e0() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function get438000015cfd48e3A66cA9d620498ede() {
    $dto = array();
...
function get6b245ecd4574426a8c5aEb5ffc4be6fd() {
    $dto = array();
    // 借记卡手续费1000以上（%）
...
function get8a04b874F0fb42b890341c0f2312455f() {
    $dto = array();
    // 借记卡手续费（%）
...
function get6b3d0c7694254a7f81f67242527947fb() {
    $dto = array();
    // 业务类型
    // $dto["fee_type"] = "test";
...
function get35c2522b739745ee96ebEb74de563476() {
    $dto = array();
    // 业务类型
    // $dto["pay_type"] = "";
    // 手续费外扣时的账户类型
...
function get528ddee015824394A99a432436e016b3() {
    $dto = array();
    // *运营媒介类型*
    // $dto["media_type"] = "test";
...
function getD6731c3f89d84d4dAc50492d1fb09871() {
    $dto = array();
    // *业务模式说明*
...
function get560e7ce156ad4f05Aa8f8a81aa997f2e() {
    $dto = array();
    // *业务模式*
...
function getF4f26dbeAf064e6481d99b8cc0af0a5c() {
    $dto = array();
...
function get89c05097Ee414abc8ab4999022272330() {
    $dto = array();
    // 开户手续费(元)
...
function getF4a6dc67C40243a6Bc03303ae934ed8b() {
    $dto = array();
    // 自动入账开关
...
function getC907987d63b44417B99c7575e84caa97() {
    $dto = array();
    // 是否交易手续费外扣
...
function getAbcfa9b4Fdcd4626B29a76d18f3debb4() {
    $dto = array();
...
function getDf740121405c47f1A29d9a2d792055d8() {
    $dto = array();
    // 归集留存金(元)
...
function get37e10343070b4d8d8ece65d7fc687d12() {
    $dto = array();
    // 分账比例
    // $dto["fee_rate"] = "test";
    // 汇付Id
...
function get974099e006e84aa9Add95fc079d6e383() {
    $dto = array();
    // *业务模式说明*
    // $dto["busi_instruction"] = "test";
    // *资金流向说明*
...
function get05142cd491da46ce81c8Bbde06dfe05e() {
    $dto = array();
    // 分账开关
    // $dto["div_flag"] = "test";
    // 分账规则来源
...
function get02f1505e03c34d90921a398b0654b283() {
    $dto = array();
    // *文件id*
    // $dto["file_id"] = "test";
    // *文件类型*
...
function getC3b607f9B1094f449d0b004386c36a28() {
    $dto = array();
    // *协议类型*
...
function get235a8eec7e604d529ce1Aa01d871481d() {
    $dto = array();
...
function get41fca06987194e2180c584dae4d2ec5b() {
    $dto = array();
    // 代发业务类型
...
function get9dbd30aa80ec4c7f99d9B6afdc7c5898() {
    $dto = array();
    // 大额支付业务模式
...
function getA6584d5494c641a7Aa89048d33cbf8da() {
    $dto = array();
    // 大额支付配置列表
...
function getAe90f4ae118349209a2bE1a93f4955d2() {
    $dto = array();
    // 代发复核开关

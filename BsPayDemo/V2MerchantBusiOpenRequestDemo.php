...
function get15f56b1675ab4288856a3bf1d33a3ef7() {
    $dto = array();
    // 签约人类型
    // $dto["type"] = "test";
...
function get6cdf5e7eCd5e4de2946fC22a2fee41e3() {
    $dto = array();
    // 联系人身份证号码
...
function get71d7834574454966Ae5aF76e886455d9() {
    $dto = array();
    // 证件持有人类型
    // $dto["legal_type"] = "";
    // 证件类型
...
function get6a420a0c1ee44c2dB371Fec6fc3f0c5e() {
    $dto = array();
    // 是否金融机构
...
function getFf84e2ea355a4407A18e532179f8beb8() {
    $dto = array();
    // 支付场景
    $dto["pay_scene"] = "1";
    // 手续费（%）
...
function get380b78c28dc242b59e2363132c19ad8a() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function get64351250C6c34a01A755Af11f150876d() {
    $dto = array();
    // 申请类型
    // $dto["apply_type"] = "test";
    // 商户支付宝账号
...
function get55c98ead7994417aBcebA158c8f6ce04() {
    $dto = array();
...
function getE0e8e68dA83c481a99b9C70119e41551() {
    $dto = array();
    // 支付场景
    $dto["pay_scene"] = "1";
    // 手续费（%）
...
function get156f8e0aF93d436dB7bb8d673f850922() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function get4d03fd2072a8434382d49c4e6668ba37() {
    $dto = array();
    // 联系人类型
...
function getF9c47476689c48f69842Fa0e76656d03() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function get1655f206036a4c6d82ceC5e352e8a045() {
    $dto = array();
    // 证件类型
...
function getCc8b73a72a164ce2Bb5f900248e2c5b0() {
    $dto = array();
    // 经营者/法人是否为受益人
    // $dto["ubo_type"] = "test";
...
function get73511282Ba6e495fBab9373a9a8e4ab7() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function getC2db7d7389f54deeA30771c9fd558b84() {
    $dto = array();
    // 经营场景类型
...
function get39a5c30f1b2d48828ea394d0e380d935() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function getDa630b8aB1b7456bB27dB705b8b80884() {
    $dto = array();
    // 登记证书类型
    // $dto["cert_type"] = "test";
    // 证书号
...
function getA7bb05b9564b4ccdAb7956621ca19377() {
    $dto = array();
    // 账户类型
    // $dto["card_type"] = "test";
    // 开户名称
...
function get46bda347851045ce9ee807d6de821468() {
    $dto = array();
    // 申请服务
...
function get56ef525c0c094c539f805f2201e66b94() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function get317493260f7b463dA50f6dca045a3ada() {
    $dto = array();
...
function get70492fccAe03435693fbD5bd4d3ce984() {
    $dto = array();
    // 借记卡手续费1000以上（%）
...
function getF0820562F99647caBf131d196303adb3() {
    $dto = array();
    // 借记卡手续费（%）
...
function get214728b640324accA062Fb391045260c() {
    $dto = array();
    // 业务类型
    // $dto["fee_type"] = "test";
    // 银行编码
...
function getEf2b6b024f3446e5B3d13f6cef67ec5c() {
    $dto = array();
    // 业务类型
    // $dto["pay_type"] = "";
    // 手续费外扣时的账户类型
...
function get243674517225497495a81179b607fbdb() {
    $dto = array();
    // *运营媒介类型*
    // $dto["media_type"] = "test";
...
function getBb0ab046C44b4df399a3B486ea81560f() {
    $dto = array();
    // *业务模式说明*
...
function get41051891Bdb34e87Bb64Fcc02e3dc143() {
    $dto = array();
    // *业务模式*
...
function getA794899d09c1489d93c3Dac8c45760e7() {
    $dto = array();
...
function get820b941070f64d0690b2C434f7a44612() {
    $dto = array();
    // 开户手续费(元)
...
function getB750d687Cbab47bbB2f939569cfd39c2() {
    $dto = array();
    // 自动入账开关
...
function getD77571fd775c4ffaB24d27b2631c7421() {
    $dto = array();
    // 是否交易手续费外扣
...
function get8bd47a8b556f4c5eA2e4Fde9a5b8f12d() {
    $dto = array();
...
function get4e59e7546a174159B1e821e0768db386() {
    $dto = array();
    // 归集留存金(元)
...
function getFf54974419424284B74d36ecc8be9024() {
    $dto = array();
    // 分账比例
    // $dto["fee_rate"] = "test";
    // 汇付Id
...
function getCd3e544c42484c4bAf92C272503382ab() {
    $dto = array();
    // *业务模式说明*
    // $dto["busi_instruction"] = "test";
    // *资金流向说明*
...
function get5f62d9af0034458d97267394d0e4bd35() {
    $dto = array();
    // 分账开关
    // $dto["div_flag"] = "test";
    // 分账规则来源
...
function getC7c1288217674b2f9d145174d898624c() {
    $dto = array();
    // *文件id*
    // $dto["file_id"] = "test";
    // *文件类型*
...
function get9504e10345644d4cB841929c8eabe0ff() {
    $dto = array();
    // *协议类型*
...
function get75f009beBfba4a169871E24bb939dd52() {
    $dto = array();
...
function getE22a0671642844c8A5588737d635fd80() {
    $dto = array();
    // 代发业务类型
...
function getD87e2a4d0ca24ef08f45Ec57a0b8558b() {
    $dto = array();
    // 大额支付业务模式
...
function get17139b700e124e52B2d1Ecc7a918954e() {
    $dto = array();
    // 大额支付配置列表
...
function getB5f37d9e6b1f4ef3B934C2c9da731dea() {
    $dto = array();
    // 代发复核开关

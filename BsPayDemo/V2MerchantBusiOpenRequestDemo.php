...
function getExtendInfos() {
    ...
    // 支付宝配置对象
    $extendInfoMap["ali_conf_list"]= get026ac522Fa4c4f0b9a9e25bf5fa2820a();
    // 支付宝直连配置对象
    // $extendInfoMap["ali_zl_conf"]= get424bc4a40a3040c5A616Cd56826a8440();
    // 开通支付宝预授权
    $extendInfoMap["alipay_pre_auth_flag"]= "N";
    // 微信配置对象
    $extendInfoMap["wx_conf_list"]= get4d02f8852ccb49b78ee01781c71a6398();
    // 微信直连配置对象
    // $extendInfoMap["wx_zl_conf"]= get6824afe4Bddc4c4d95d33b449134f338();
    // 开通微信预授权
    $extendInfoMap["wechatpay_pre_auth_flag"]= "N";
    // 银联二维码配置
    $extendInfoMap["union_conf_list"]= get69bc2d4563fb43ffB98017ec1008f215();
    // 银行卡业务配置
    $extendInfoMap["bank_card_conf"]= get37df90c591a04b5bAeacB366915dd5d6();
    // 线上费率配置
    // $extendInfoMap["online_fee_conf_list"]= get4105d915Af1541ccA1507cdbab7d357a();
    // 线上手续费承担方配置
    // $extendInfoMap["online_pay_fee_conf_list"]= get6cb7c42aF0974248Ad781b582d94a244();
    // 运营媒介
    // $extendInfoMap["online_media_info_list"]= get290a5b7f03bf457cBd2248fe418fd635();
    // *余额支付配置*
    $extendInfoMap["balance_pay_config"]= getD1f7e93dE13f4a7c95606a3351e27495();
    // 全域资金管理配置(华通银行)
    // $extendInfoMap["out_order_funds_config"]= getEceaa0a102e34914Bacb8a508af7490d();
    // 补贴支付
    $extendInfoMap["combine_pay_config"]= get6afda0e343eb445084d53beb9b412155();
    // 花呗分期费率配置
    $extendInfoMap["hb_fq_fee_config"]= getC04cb1551c8b46af92c763fcbccc57d7();
    // 汇总结算配置
    // $extendInfoMap["collection_settle_config_list"]= get4da99e7aEbcb440bBea89b59b6c674cd();
    // 分账配置信息
    // $extendInfoMap["split_conf_info"]= get46961f1a9e9a42118392Fb9f7e40aa5b();
    // 延迟入账开关
    ...
    // *补充文件信息*
    // $extendInfoMap["extended_material_list"]= get909c999bA8b445c090b0Fae3c116d120();
    // 开户费用值(元)
    ...
    // 银联线上收银台
    // $extendInfoMap["uni_app_payment_config"]= getE9f685328fb04489A3e7Dd05d5968fbc();
    // 资金归集开通标记
    // $extendInfoMap["fund_collection_flag"]= "";
    // 代发配置
    // $extendInfoMap["surrogate_config_list"]= get2878523a800b431888cf72100e6832b4();
    // 大额支付配置
    // $extendInfoMap["large_amt_pay_config"]= getD8688c6a434c4bba871bBe342fd472fb();
    // 托管支付开关
    // $extendInfoMap["half_pay_host_flag"]= "";
    // 代发复核配置
    // $extendInfoMap["agent_recheck_config"]= get14e9b15dEbb744e8B5a40f9eeac0956b();
    // 商户开通网银充值开关
    // $extendInfoMap["online_recharge_flag"]= "";
    return $extendInfoMap;
}

function get8b58aa20387c4b58Be0cF25e08b1fefe() {
    $dto = array();
    // 签约人类型
    // $dto["type"] = "test";
...
function get9f6204410b5d45e081915eef41bc6afe() {
    $dto = array();
    // 联系人身份证号码
...
function get653f8de2Aedb4fb7Af2653d6c2451458() {
    $dto = array();
    // 证件持有人类型
    // $dto["legal_type"] = "";
    // 证件类型
...
function get84b9831bE4b046ddA580310b1c8a1b10() {
    $dto = array();
    // 是否金融机构
    ...
    // 联系人信息对象
    // $dto["contact_person_info"] = get9f6204410b5d45e081915eef41bc6afe();
    // 法人身份信息
    // $dto["legal_person_info"] = get653f8de2Aedb4fb7Af2653d6c2451458();

    return $dto;
}

function get026ac522Fa4c4f0b9a9e25bf5fa2820a() {
    $dto = array();
    // 支付场景
    $dto["pay_scene"] = "1";
    // 手续费（%）
    ...
    // 实名认证信息
    // $dto["al_real_name_info"] = get84b9831bE4b046ddA580310b1c8a1b10();
    // *商户经营类目*
...
function getB49086fc2ba14fc692f3688c87cd19cb() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function get424bc4a40a3040c5A616Cd56826a8440() {
    $dto = array();
    // 申请类型
    // $dto["apply_type"] = "test";
    // 商户支付宝账号
    ...
    // $dto["fee_rate"] = "test";
    // 文件列表
    // $dto["file_list"] = getB49086fc2ba14fc692f3688c87cd19cb();
    // 联系人姓名
    // $dto["contact_name"] = "";
    // 联系人手机号
...
function get373deb55F5c848589733154152547e94() {
    $dto = array();
...
function get4d02f8852ccb49b78ee01781c71a6398() {
    $dto = array();
    // 支付场景
    $dto["pay_scene"] = "1";
    // 手续费（%）
    ...
    // $dto["is_check_real_name"] = "";
    // 实名认证信息
    // $dto["wx_real_name_info"] = get373deb55F5c848589733154152547e94();
...
function getBa0f2bddDe924aa3A226C0a8bf37ac03() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function get43dcb3051c174e2999aa958d333d51a9() {
    $dto = array();
    // 联系人类型
    ...
    // $dto["contact_file_list"] = getBa0f2bddDe924aa3A226C0a8bf37ac03();
    // 证件有效期类型
...
function getDe30fdcf93e2449fB12cE20592d40152() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function getE88ec054F52e453b99b780005a2cca55() {
    $dto = array();
    // 证件类型
    ...
    // 文件列表
    // $dto["ubo_file_list"] = getDe30fdcf93e2449fB12cE20592d40152();
    // 证件有效期截止日期
...
function getCf74e165F2614313Ba9cE432e65f9b8a() {
    $dto = array();
    // 经营者/法人是否为受益人
    // $dto["ubo_type"] = "test";
    // 受益人信息列表jsonArray格式,当ubo_type为Y时可不填
    // $dto["ubo_info_list"] = getE88ec054F52e453b99b780005a2cca55();

    return $dto;
}

function get2ca59939262440c3B95d30b13061551a() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function get4f537eab57aa43a1A211Fd518bfbde14() {
    $dto = array();
    // 经营场景类型
    ...
    // 文件列表
    // $dto["sales_scenes_file_list"] = get2ca59939262440c3B95d30b13061551a();
    // 文件列表
...
function get6c7be5e681f74f079b9e371f16aaeeb6() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function get08b7aa24911b4296Ad777a6d8ca03637() {
    $dto = array();
    // 登记证书类型
    // $dto["cert_type"] = "test";
    // 证书号
    ...
    // 文件列表
    // $dto["cert_file_list"] = get6c7be5e681f74f079b9e371f16aaeeb6();
    // 证书有效期截止日期
    // $dto["cert_end_date"] = "";
...
function get091e205f225e4feb93d18e4844e0d0d9() {
    $dto = array();
    // 账户类型
    // $dto["card_type"] = "test";
    // 开户名称
...
function get2e683fc56d19440fB29a4f59c8ae9377() {
    $dto = array();
    // 申请服务
...
function get67c27283754b40568116F25f935a8217() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function get6824afe4Bddc4c4d95d33b449134f338() {
    $dto = array();
    // 微信子商户号微信支付分配的子商户号；&lt;font color&#x3D;&quot;green&quot;&gt;示例值：1632157057&lt;/font&gt;
    // $dto["sub_mch_id"] = "test";
    // 联系人信息jsonObject字符串,新增时必填
    // $dto["contact_info"] = get43dcb3051c174e2999aa958d333d51a9();
    // 最终受益人信息jsonObject字符串，商户类型为企业时，微信侧必填。（如果基本信息里有的话，可以不传取 huifu_id 对应的信息）。新增时填入
    // $dto["ubo_info"] = getCf74e165F2614313Ba9cE432e65f9b8a();
    // 经营场景jsonObject字符串，新增时填入
    // $dto["sales_info"] = get4f537eab57aa43a1A211Fd518bfbde14();
    // 特殊主体登记证书jsonObject字符串，商户营业执照类型为政府机关/事业单位/其他组织时，传入相应信息。新增时需填入
    // $dto["certificate_info"] = get08b7aa24911b4296Ad777a6d8ca03637();
    // 银行账户信息jsonObject字符串，该字段不填时，取商户在汇付系统录入的结算账号信息。新增或修改时填入，修改时必填
    // $dto["wx_card_info"] = get091e205f225e4feb93d18e4844e0d0d9();
    // 配置集合对指定的sub_mch_id做配置
    // $dto["wx_zl_pay_conf_list"] = get2e683fc56d19440fB29a4f59c8ae9377();
    // 操作类型ADD-新增， UPDATE-修改， 默认新增；&lt;font color&#x3D;&quot;green&quot;&gt;示例值：ADD&lt;/font&gt;
    // $dto["operate_type"] = "test";
    // 补充说明信息
    // $dto["business_addition_msg"] = "";
    // 补充说明文件列表
    // $dto["addition_file_list"] = get67c27283754b40568116F25f935a8217();

    return json_encode($dto,JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES);
}

function get69bc2d4563fb43ffB98017ec1008f215() {
    $dto = array();
    // 借记卡手续费（%）
...
function get37df90c591a04b5bAeacB366915dd5d6() {
    $dto = array();
    // 借记卡手续费（%）
...
function get4105d915Af1541ccA1507cdbab7d357a() {
    $dto = array();
    // 业务类型
    // $dto["fee_type"] = "test";
...
function get6cb7c42aF0974248Ad781b582d94a244() {
    $dto = array();
    // 业务类型
    // $dto["pay_type"] = "";
    // 手续费外扣时的账户类型
...
function get290a5b7f03bf457cBd2248fe418fd635() {
    $dto = array();
    // *运营媒介类型*
    // $dto["media_type"] = "test";
...
function getA25edecf2c0c417eB7293e08371e98ee() {
    $dto = array();
    // *业务模式说明*
...
function getD1f7e93dE13f4a7c95606a3351e27495() {
    $dto = array();
    // *业务模式*
    // $dto["balance_model"] = "test";
    // 业务情况说明
    // $dto["description_info"] = getA25edecf2c0c417eB7293e08371e98ee();
    // 手续费(%)
    $dto["fee_rate"] = "2";
    // 手续费（固定/元）
    $dto["fee_fix_amt"] = "1";
...
function get0c19544e03c04d5e93d028d1eb74a598() {
    $dto = array();
...
function get7b034ae2Db4c4b4692df81aecaf2d087() {
    $dto = array();
    // 开户手续费(元)
...
function getEceaa0a102e34914Bacb8a508af7490d() {
    $dto = array();
    // 自动入账开关
    ...
    // $dto["out_fee_huifuid"] = "";
    // 全域资金开户银行卡信息
    // $dto["out_order_acct_card"] = get0c19544e03c04d5e93d028d1eb74a598();
    // 全域资金开户手续费
    // $dto["out_order_acct_open_fees"] = get7b034ae2Db4c4b4692df81aecaf2d087();
    // 全域支付业务模式
    // $dto["business_model"] = "";
...
function get6afda0e343eb445084d53beb9b412155() {
    $dto = array();
    // 是否交易手续费外扣
...
function getC04cb1551c8b46af92c763fcbccc57d7() {
    $dto = array();
...
function get4da99e7aEbcb440bBea89b59b6c674cd() {
    $dto = array();
    // 归集留存金(元)
...
function get049934de471448939df3Cb2e02e6a1e9() {
    $dto = array();
    // 分账比例
    // $dto["fee_rate"] = "test";
    // 汇付Id
...
function getBa3ca0c5B373417f842d662948a6753d() {
    $dto = array();
    // *业务模式说明*
    // $dto["busi_instruction"] = "test";
    // *资金流向说明*
...
function get46961f1a9e9a42118392Fb9f7e40aa5b() {
    $dto = array();
    // 分账开关
    // $dto["div_flag"] = "test";
    // 分账规则来源
    ...
    // $dto["scene"] = "test";
    // 分账明细
    // $dto["acct_split_bunch_list"] = get049934de471448939df3Cb2e02e6a1e9();
    // 手续费外扣开关
    // $dto["out_fee_flag"] = "";
    // 手续费外扣时的账户类型
    // $dto["out_fee_acct_type"] = "";
    ...
    // $dto["per_amt"] = "";
    // 业务情况说明
    // $dto["split_ext_info"] = getBa3ca0c5B373417f842d662948a6753d();

    return json_encode($dto,JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES);
}

function get909c999bA8b445c090b0Fae3c116d120() {
    $dto = array();
    // *文件id*
    // $dto["file_id"] = "test";
    // *文件类型*
...
function get2934cf293a84429dA177922f465fbbdc() {
    $dto = array();
    // *协议类型*
...
function getE9f685328fb04489A3e7Dd05d5968fbc() {
    $dto = array();
...
function get2878523a800b431888cf72100e6832b4() {
    $dto = array();
    // 代发业务类型
...
function get01b9a639116b497f8c9863d7142a7348() {
    $dto = array();
    // 大额支付业务模式
...
function getD8688c6a434c4bba871bBe342fd472fb() {
    $dto = array();
    // 大额支付配置列表
    // $dto["large_amt_pay_config_info_list"] = get01b9a639116b497f8c9863d7142a7348();
...
function get14e9b15dEbb744e8B5a40f9eeac0956b() {
    $dto = array();
    // 代发复核开关

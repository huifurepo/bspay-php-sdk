...
function getExtendInfos() {
    ...
    // 支付宝配置对象
    $extendInfoMap["ali_conf_list"]= getCce4f6b4Cb6e4987A7c94b2e13ec7864();
    // 支付宝直连配置对象
    // $extendInfoMap["ali_zl_conf"]= getCba04562B3bd4694Ac92461821c76e5c();
    // 开通支付宝预授权
    $extendInfoMap["alipay_pre_auth_flag"]= "N";
    // 微信配置对象
    $extendInfoMap["wx_conf_list"]= getA24609c706004e31A26f5a757b429ff0();
    // 微信直连配置对象
    // $extendInfoMap["wx_zl_conf"]= getAf8ab85b9604403683a78b5ae84603ec();
    // 开通微信预授权
    $extendInfoMap["wechatpay_pre_auth_flag"]= "N";
    // 银联二维码配置
    $extendInfoMap["union_conf_list"]= get275b51178b29435dB687485ea185bd04();
    // 银行卡业务配置
    $extendInfoMap["bank_card_conf"]= getC49684f523a84969B1a81fed50b9183e();
    // 线上费率配置
    // $extendInfoMap["online_fee_conf_list"]= get172600159b014ad99697E59f938c8cc8();
    // 线上手续费承担方配置
    // $extendInfoMap["online_pay_fee_conf_list"]= get0cfe5f55Dac84f819bac5abe3c5575d5();
    // 运营媒介
    // $extendInfoMap["online_media_info_list"]= get6681da60033643d8A489C56e9e7ce373();
    // *余额支付配置*
    $extendInfoMap["balance_pay_config"]= getE6cec91d25d24e99Bab20a351c29ccfe();
    // 全域资金管理配置(华通银行)
    // $extendInfoMap["out_order_funds_config"]= getB1b25c693cf24d6c82d40014b506576d();
    // 补贴支付
    $extendInfoMap["combine_pay_config"]= get837a3f99414c425693f546da41f44a57();
    // 花呗分期费率配置
    $extendInfoMap["hb_fq_fee_config"]= get0cbcad0a58204d33908366e38da2f129();
    // 汇总结算配置
    // $extendInfoMap["collection_settle_config_list"]= get3873d02eA6a04c9f85aa82622b13a2d8();
    // 分账配置信息
    // $extendInfoMap["split_conf_info"]= get1738a0c45e0f42f6Be9490016d79537d();
    // 延迟入账开关
    ...
    // *补充文件信息*
    // $extendInfoMap["extended_material_list"]= get9dabc2a9159b401f9fa9B38eccd227f1();
    // 开户费用值(元)
    ...
    // 银联线上收银台
    // $extendInfoMap["uni_app_payment_config"]= get7fdb8e3c73ac47a8A60768494068edf4();
    // 资金归集开通标记
    // $extendInfoMap["fund_collection_flag"]= "";
    // 代发配置
    // $extendInfoMap["surrogate_config_list"]= get70c4a8202f234f7c9060Dc4a575fbf98();
    // 大额支付配置
    // $extendInfoMap["large_amt_pay_config"]= get82733ccbB9704fb8B34376a69c5cadc3();
    // 托管支付开关
    // $extendInfoMap["half_pay_host_flag"]= "";
    return $extendInfoMap;
}

function get3c8773945ac84362Beb759d7bb693582() {
    $dto = array();
    // 签约人类型
    // $dto["type"] = "test";
...
function get0624536693a148a5877fC84cab147155() {
    $dto = array();
    // 联系人身份证号码
...
function getB8eeb6d2Dfd74747A7d144dffef9854e() {
    $dto = array();
    // 证件持有人类型
    // $dto["legal_type"] = "";
    // 证件类型
...
function get5798c16d189743e594c60e9c38f286a1() {
    $dto = array();
    // 是否金融机构
    ...
    // 联系人信息对象
    // $dto["contact_person_info"] = get0624536693a148a5877fC84cab147155();
    // 法人身份信息
    // $dto["legal_person_info"] = getB8eeb6d2Dfd74747A7d144dffef9854e();

    return $dto;
}

function getCce4f6b4Cb6e4987A7c94b2e13ec7864() {
    $dto = array();
    // 支付场景
    $dto["pay_scene"] = "1";
    // 手续费（%）
    ...
    // 实名认证信息
    // $dto["al_real_name_info"] = get5798c16d189743e594c60e9c38f286a1();
    // *商户经营类目*
...
function get4326ae77Ff9147a98f19A7c41e8908d7() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function getCba04562B3bd4694Ac92461821c76e5c() {
    $dto = array();
    // 申请类型
    // $dto["apply_type"] = "test";
    // 商户支付宝账号
    ...
    // $dto["fee_rate"] = "test";
    // 文件列表
    // $dto["file_list"] = get4326ae77Ff9147a98f19A7c41e8908d7();
    // 联系人姓名
    // $dto["contact_name"] = "";
    // 联系人手机号
...
function getDdca9ecc99ad4bc396a5B64e67a6dfe1() {
    $dto = array();
...
function getA24609c706004e31A26f5a757b429ff0() {
    $dto = array();
    // 支付场景
    $dto["pay_scene"] = "1";
    // 手续费（%）
    ...
    // $dto["is_check_real_name"] = "";
    // 实名认证信息
    // $dto["wx_real_name_info"] = getDdca9ecc99ad4bc396a5B64e67a6dfe1();
...
function get2d5be541B47a4706860a6b435c2429ab() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function getE261e0fd3fc34c28A7b9A463f3b59897() {
    $dto = array();
    // 联系人类型
    ...
    // $dto["contact_file_list"] = get2d5be541B47a4706860a6b435c2429ab();
    // 证件有效期类型
...
function getA0e3348cB4264adb82bc647b99e81de6() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function getAbe2415a9d0c42ee8f453da005678267() {
    $dto = array();
    // 证件类型
    ...
    // 文件列表
    // $dto["ubo_file_list"] = getA0e3348cB4264adb82bc647b99e81de6();
    // 证件有效期截止日期
...
function get1eb6bfb2Dc0a4ec9B569871f04c169d3() {
    $dto = array();
    // 经营者/法人是否为受益人
    // $dto["ubo_type"] = "test";
    // 受益人信息列表jsonArray格式,当ubo_type为Y时可不填
    // $dto["ubo_info_list"] = getAbe2415a9d0c42ee8f453da005678267();

    return $dto;
}

function get4bd9a972714c4670Acae04a18d57e2fe() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function get4d8de8d69d6d4c4f95e2Fcfdd9c69159() {
    $dto = array();
    // 经营场景类型
    ...
    // 文件列表
    // $dto["sales_scenes_file_list"] = get4bd9a972714c4670Acae04a18d57e2fe();
    // 文件列表
...
function getC2e1217632fa4785B16b49c5c68a4b55() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function get3d2fd20aBd614e0d9eb5Af4d4794bcc7() {
    $dto = array();
    // 登记证书类型
    // $dto["cert_type"] = "test";
    // 证书号
    ...
    // 文件列表
    // $dto["cert_file_list"] = getC2e1217632fa4785B16b49c5c68a4b55();
    // 证书有效期截止日期
    // $dto["cert_end_date"] = "";
...
function get7f099e609ebd4868Afaa0d5e9ed8b446() {
    $dto = array();
    // 账户类型
    // $dto["card_type"] = "test";
    // 开户名称
...
function get6daaeac4A03a46f49d092c4732287596() {
    $dto = array();
    // 申请服务
...
function getBca8f3e499444c449581Fa6309f69168() {
    $dto = array();
    // 文件类型
    // $dto["file_type"] = "test";
    // 文件jfileId
...
function getAf8ab85b9604403683a78b5ae84603ec() {
    $dto = array();
    // 微信子商户号微信支付分配的子商户号；&lt;font color&#x3D;&quot;green&quot;&gt;示例值：1632157057&lt;/font&gt;
    // $dto["sub_mch_id"] = "test";
    // 联系人信息jsonObject字符串,新增时必填
    // $dto["contact_info"] = getE261e0fd3fc34c28A7b9A463f3b59897();
    // 最终受益人信息jsonObject字符串，商户类型为企业时，微信侧必填。（如果基本信息里有的话，可以不传取 huifu_id 对应的信息）。新增时填入
    // $dto["ubo_info"] = get1eb6bfb2Dc0a4ec9B569871f04c169d3();
    // 经营场景jsonObject字符串，新增时填入
    // $dto["sales_info"] = get4d8de8d69d6d4c4f95e2Fcfdd9c69159();
    // 特殊主体登记证书jsonObject字符串，商户营业执照类型为政府机关/事业单位/其他组织时，传入相应信息。新增时需填入
    // $dto["certificate_info"] = get3d2fd20aBd614e0d9eb5Af4d4794bcc7();
    // 银行账户信息jsonObject字符串，该字段不填时，取商户在汇付系统录入的结算账号信息。新增或修改时填入，修改时必填
    // $dto["wx_card_info"] = get7f099e609ebd4868Afaa0d5e9ed8b446();
    // 配置集合对指定的sub_mch_id做配置
    // $dto["wx_zl_pay_conf_list"] = get6daaeac4A03a46f49d092c4732287596();
    // 操作类型ADD-新增， UPDATE-修改， 默认新增；&lt;font color&#x3D;&quot;green&quot;&gt;示例值：ADD&lt;/font&gt;
    // $dto["operate_type"] = "test";
    // 补充说明信息
    // $dto["business_addition_msg"] = "";
    // 补充说明文件列表
    // $dto["addition_file_list"] = getBca8f3e499444c449581Fa6309f69168();

    return json_encode($dto,JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES);
}

function get275b51178b29435dB687485ea185bd04() {
    $dto = array();
    // 借记卡手续费1000以上（%）
...
function getC49684f523a84969B1a81fed50b9183e() {
    $dto = array();
    // 借记卡手续费（%）
...
function get172600159b014ad99697E59f938c8cc8() {
    $dto = array();
    // 业务类型
    // $dto["fee_type"] = "test";
    // 银行编码
...
function get0cfe5f55Dac84f819bac5abe3c5575d5() {
    $dto = array();
    // 业务类型
    // $dto["pay_type"] = "";
    // 手续费外扣时的账户类型
...
function get6681da60033643d8A489C56e9e7ce373() {
    $dto = array();
    // *运营媒介类型*
    // $dto["media_type"] = "test";
...
function get19917293Eb4e4f69A318D2801aaf1350() {
    $dto = array();
    // *业务模式说明*
...
function getE6cec91d25d24e99Bab20a351c29ccfe() {
    $dto = array();
    // *业务模式*
    // $dto["balance_model"] = "test";
    // 业务情况说明
    // $dto["description_info"] = get19917293Eb4e4f69A318D2801aaf1350();
    // 手续费(%)
    $dto["fee_rate"] = "2";
    // 手续费（固定/元）
    $dto["fee_fix_amt"] = "1";
...
function getB038ee22379c493282f75a455f9f5e7c() {
    $dto = array();
...
function getC1cd7ac3F96644178b51E0801e79ac7b() {
    $dto = array();
    // 开户手续费(元)
...
function getB1b25c693cf24d6c82d40014b506576d() {
    $dto = array();
    // 自动入账开关
    ...
    // $dto["out_fee_huifuid"] = "";
    // 全域资金开户银行卡信息
    // $dto["out_order_acct_card"] = getB038ee22379c493282f75a455f9f5e7c();
    // 全域资金开户手续费
    // $dto["out_order_acct_open_fees"] = getC1cd7ac3F96644178b51E0801e79ac7b();
    // 全域支付业务模式
    // $dto["business_model"] = "";
...
function get837a3f99414c425693f546da41f44a57() {
    $dto = array();
    // 是否交易手续费外扣
...
function get0cbcad0a58204d33908366e38da2f129() {
    $dto = array();
...
function get3873d02eA6a04c9f85aa82622b13a2d8() {
    $dto = array();
    // 归集留存金(元)
...
function getFd9a9a9e1e6f4ae3Bac196d881799d11() {
    $dto = array();
    // 分账比例
    // $dto["fee_rate"] = "test";
    // 汇付Id
...
function get2929d74a16024e7eB41f041391199855() {
    $dto = array();
    // *业务模式说明*
    // $dto["busi_instruction"] = "test";
    // *资金流向说明*
...
function get1738a0c45e0f42f6Be9490016d79537d() {
    $dto = array();
    // 分账开关
    // $dto["div_flag"] = "test";
    // 分账规则来源
    ...
    // $dto["scene"] = "test";
    // 分账明细
    // $dto["acct_split_bunch_list"] = getFd9a9a9e1e6f4ae3Bac196d881799d11();
    // 手续费外扣开关
    // $dto["out_fee_flag"] = "";
    // 手续费外扣时的账户类型
    // $dto["out_fee_acct_type"] = "";
    ...
    // $dto["per_amt"] = "";
    // 业务情况说明
    // $dto["split_ext_info"] = get2929d74a16024e7eB41f041391199855();

    return json_encode($dto,JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES);
}

function get9dabc2a9159b401f9fa9B38eccd227f1() {
    $dto = array();
    // *文件id*
    // $dto["file_id"] = "test";
    // *文件类型*
...
function getCae5994403d54f2793fc6707d49c65e2() {
    $dto = array();
    // *协议类型*
...
function get7fdb8e3c73ac47a8A60768494068edf4() {
    $dto = array();
...
function get70c4a8202f234f7c9060Dc4a575fbf98() {
    $dto = array();
    // 代发业务类型
...
function get9229bdd57f4a40278a8b6abb83cc57c7() {
    $dto = array();
    // 大额支付业务模式
...
function get82733ccbB9704fb8B34376a69c5cadc3() {
    $dto = array();
    // 大额支付配置列表
    // $dto["large_amt_pay_config_info_list"] = get9229bdd57f4a40278a8b6abb83cc57c7();

...
function get63a6b073902e419eB91e7a740f7cefac() {
    $dto = array();
    // 分账金额
    $dto["div_amt"] = "0.08";
    // 分账接收方ID
...
function get39f6420664b148149da58404e125c596() {
    $dto = array();
    // 分账明细
...
function get4042f384251d4c77807035708eacfa3c() {
    $dto = array();
    // 项目标题
...
function getA3541a4116904b349680106de1eea9b3() {
    $dto = array();
    // 是否提供校验身份信息
...
function getCef0aecdE05c448a9c6dC79304f6cab2() {
    $dto = array();
    // 指定支付者
...
function get81f06d0aA68148cc8b3b87ee7de4d154() {
    $dto = array();
    // 姓名
    $dto["name"] = "张三";
    // 证件类型
...
function get7883a775A4224d08Bd586d50047415fc() {
    $dto = array();
    // 付款人验证（支付宝）
...
function get35b43c489b5e4ca69831A14fc0ac6dcb() {
    $dto = array();
    // 商品编码
    // $dto["goods_id"] = "";
    // 商品名称
...
function get6e0e5011B3984e529ef71174482657e8() {
    $dto = array();
    // 单品列表
...
function getE32d985d5db549c8B35d1584068652ad() {
    $dto = array();
    // 门店id
    // $dto["id"] = "";
    // 门店名称
...
function getC830766245e0435b994f38d6c8d8c67f() {
    $dto = array();
    // 门店信息
...
function get9bdf3590B90f4a5888a81744c4a5c883() {
    $dto = array();
    // 附加数据
    // $dto["attach"] = "";
    // 商品详情
...
function get3324c2378c80426f8f80F1a3eb6b9dfd() {
    $dto = array();
    // 卡类型
    // $dto["card_type"] = "";
    // 支付宝点餐场景类型
...
function get7429857a3bb749188a5334e78512f968() {
    $dto = array();
    // 商品的编号
    // $dto["goods_id"] = "test";
    // 商品名称
...
function get13ec3142F1f64cdc9b8520ec6e31bae3() {
    $dto = array();
    // 支付宝的店铺编号
    // $dto["alipay_store_id"] = "";
    // 业务扩展参数
...
function get35b29ab2A292431e93c2F1baea475eae() {
    $dto = array();
    // 商户类别
    // $dto["mer_cat_code"] = "";
    // 二级商户代码
...
function get597016da5e814ac8AddeDf9d141705c8() {
    $dto = array();
    // 收款方附加数据
    // $dto["addn_data"] = "";
    // 地区信息
...
function get039933ea70ab4737B4b7695a457f8046() {
    $dto = array();
    // 汇付机具号
    // $dto["devs_id"] = "test";
...
function get1665fc0c387d48beB8f2E3c14686b590() {
    $dto = array();
    // 付款方名称

...
function getExtendInfos() {
    ...
    // 花呗分期费率
    $extendInfoMap["hb_fq_fee_list"]= get865775a727804856Ad741adce92a4684();
    // 白条分期配置对象
    // $extendInfoMap["jdbt_data"]= getC075c7bdC59c4fddA4c6F2e94f027c3e();
    // 银联聚分期配置对象
    // $extendInfoMap["yljfq_data"]= get0c1a7c7fC85348999562B33cf515424e();
    return $extendInfoMap;
}

function get865775a727804856Ad741adce92a4684() {
    $dto = array();
    // 商户汇付Id
...
function getF0d72829Ff5f4749A6c3C2f5093c1414() {
    $dto = array();
    // 支付场景
    // $dto["pay_scene"] = "test";
    // 业务开通标识
...
function getC075c7bdC59c4fddA4c6F2e94f027c3e() {
    $dto = array();
    // 商户汇付Id
    // $dto["huifu_id"] = "test";
    // 签约人类型
    ...
    // 京东白条费率数据
    // $dto["jdbt_fee_data"] = getF0d72829Ff5f4749A6c3C2f5093c1414();
    // 签约人姓名
    // $dto["name"] = "";
    // 签约人身份证号
    // $dto["cert_no"] = "";
...
function getC507fa5a1214468194f1Fe6fd88be99c() {
    $dto = array();
    // 支付场景
    // $dto["pay_scene"] = "test";
    // 业务开通标识
...
function getEe28a633804a4e1184fbA80ea67c0887() {
    $dto = array();
    // 文件id
    // $dto["file_id"] = "test";
    // 文件类型
...
function get0c1a7c7fC85348999562B33cf515424e() {
    $dto = array();
    // 商户汇付Id
    // $dto["huifu_id"] = "test";
    // 签约人类型
    ...
    // $dto["mobile_no"] = "test";
    // 银联聚分期费率数据
    // $dto["yljfq_fee_data"] = getC507fa5a1214468194f1Fe6fd88be99c();
    // 签约人姓名
    // $dto["name"] = "";
    // 签约人身份证号
    // $dto["cert_no"] = "";
    // 补充业务信息
    // $dto["file_list"] = getEe28a633804a4e1184fbA80ea67c0887();

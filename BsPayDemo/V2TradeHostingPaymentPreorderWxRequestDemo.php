...
// 微信小程序扩展参数集合
$request->setMiniappData(get79ae16abF80243edA1d2716c18993dc8());
...
function getB32820656b19491f8493Aedc93824585() {
    $dto = array();
    // 商户贴息标记
...
function get7b637af0A8a54de5B5b870f0910a95be() {
    $dto = array();
    // 分账金额
    $dto["div_amt"] = "0.01";
    // 分账接收方ID
...
function getCeb7c110604a4eb38a354b753b81e01b() {
    $dto = array();
    // 分账明细
...
function get79ae16abF80243edA1d2716c18993dc8() {
    $dto = array();
    // 是否生成scheme_code
    $dto["need_scheme"] = "Y";
    // 应用ID
...
function get7ffdabd5E3f746ca982369231061f240() {
    $dto = array();
    // 指定支付者
    // $dto["limit_payer"] = "";
    // 微信实名验证
...
function get0793f164B5b145788ff8Fa84a17ca207() {
    $dto = array();
    // 姓名
    // $dto["name"] = "";
    // 证件类型
...
function get0f1e1b4eA8f9463981573b6d52fca20a() {
    $dto = array();
    // 付款人验证（微信）
...
function get5ff89689878e4a6e933622ed380efe16() {
    $dto = array();
    // 商品编码
    // $dto["goods_id"] = "";
    // 商品名称
...
function getDe266714D5b449028d11C7a909c892bd() {
    $dto = array();
    // 单品列表
...
function get786f1eb02d7942e3905fA5d785d10ecd() {
    $dto = array();
    // 门店id
    // $dto["id"] = "";
    // 门店名称
...
function getD0cb0ae880e946238db7025f18752e7c() {
    $dto = array();
    // 门店信息
...
function get3857dabb491b41e9970e2222c78d52fe() {
    $dto = array();
    // 子商户应用ID
    // $dto["sub_appid"] = "";
    // 子商户用户标识
...
function getAb459ff28d4b44f4Bfc77c6c7dee40fe() {
    $dto = array();
    // 汇付机具号
    // $dto["devs_id"] = "test";

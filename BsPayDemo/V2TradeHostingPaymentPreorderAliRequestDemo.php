...
// app扩展参数集合
$request->setAppData(getCaf919d174a747ce811d2772ead1c7bd());
...
function get3bb1f566Af3743d2B02143513c8dda62() {
    $dto = array();
    // 分账金额
    $dto["div_amt"] = "0.08";
    // 分账接收方ID
...
function get6d7987d09b7e4195A0a7C208d15520f8() {
    $dto = array();
    // 分账明细
...
function get35e49462Cd404a19A826D74ed26ff260() {
    $dto = array();
    // 项目号
    // $dto["project_id"] = "";
...
function getCaf919d174a747ce811d2772ead1c7bd() {
    $dto = array();
    // 小程序返回码
...
function get85d733018552422f93bb0d16beb30b60() {
    $dto = array();
    // 是否提供校验身份信息
    // $dto["need_check_info"] = "";
    // 允许的最小买家年龄
...
function get13e49d1280ef4d889035Dfb6ffa97879() {
    $dto = array();
    // 姓名
    // $dto["name"] = "";
    // 证件类型
...
function get47e9a48182ab464b9c6b9cfae2abfccc() {
    $dto = array();
    // 付款人验证（支付宝）
...
function get62a133f12c784426Bf6cF7caaaa51d78() {
    $dto = array();
    // 卡类型
    // $dto["card_type"] = "";
    // 支付宝点餐场景类型
...
function get9a2322814ae94e318af35748d929bcee() {
    $dto = array();
    // 商品的编号
    // $dto["goods_id"] = "test";
    // 商品名称
...
function get024e46e48e0e48da90571f1ba66c61f2() {
    $dto = array();
    // 支付宝的店铺编号
    // $dto["alipay_store_id"] = "";
    // 业务扩展参数
...
function getE78cca1cA06d4f19B17585f39caa1f44() {
    $dto = array();
    // 汇付机具号
    // $dto["devs_id"] = "test";

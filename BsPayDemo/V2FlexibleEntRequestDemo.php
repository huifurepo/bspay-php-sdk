...
require_once  dirname(__FILE__). "/../BsPaySdk/request/V2FlexibleEntRequest.php";

use BsPaySdk\core\BsPayClient;
use BsPaySdk\request\V2FlexibleEntRequest;

// 2.组装请求参数
$request = new V2FlexibleEntRequest();
// 请求流水号
...
function getExtendInfos() {
    ...
    // 取现业务配置
    // $extendInfoMap["cash_config"]= get82680182D37042b7Ab797c407741c176();
    // 大额支付配置
    // $extendInfoMap["large_amt_pay_config"]= get0c99d8834baf4f3792a7A78c13417cec();
    // 是否开通网银充值
    // $extendInfoMap["online_recharge_flag"]= "";
    // 线上费率配置
    // $extendInfoMap["online_fee_conf_list"]= getE90021b991164973820f25f5e7975a43();
    // 线上手续费承担方配置
    // $extendInfoMap["online_pay_fee_conf_list"]= get0782b7d7Cd794386B2dd9b29b024cbf2();
    // 灵工支付配置
    // $extendInfoMap["flexible_pay_config"]= getCa56ed7d7f644d34B6a3D2f7defd468a();
    // 协议类型
    ...
    // 扩展资料包
    // $extendInfoMap["extended_material_list"]= get1470e580Dd1447238c4d648a5b9df5a2();
    return $extendInfoMap;
}

function getCff4727cC05a40fcA9b602e2f00fedaa() {
    $dto = array();
    // 银行账户名
    $dto["card_name"] = "圆务铁白事";
    // 银行账号
...
function get82680182D37042b7Ab797c407741c176() {
    $dto = array();
...
function get5fcdf21dF035449393d0A1078791a92f() {
    $dto = array();
...
function get0c99d8834baf4f3792a7A78c13417cec() {
    $dto = array();
    // 大额支付配置列表
    // $dto["large_amt_pay_config_info_list"] = get5fcdf21dF035449393d0A1078791a92f();
...
function getE90021b991164973820f25f5e7975a43() {
    $dto = array();
    // 银行编码
    // $dto["bank_id"] = "test";
    // 功能开关状态
...
function get0782b7d7Cd794386B2dd9b29b024cbf2() {
    $dto = array();
    // 业务类型
    // $dto["pay_type"] = "";
    // 手续费外扣时的账户类型
...
function getCa56ed7d7f644d34B6a3D2f7defd468a() {
    $dto = array();
    // 是否交易手续费外扣
...
function getF32bb9080f5f4bee9931109c8b31f8ec() {
    $dto = array();
...
function get1470e580Dd1447238c4d648a5b9df5a2() {
    $dto = array();
    // 文件id
    // $dto["file_id"] = "test";
    // 文件类型

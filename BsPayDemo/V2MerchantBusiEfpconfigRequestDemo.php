...
function getB47ba2e79cd2411f8fa5E17120169b59() {
    $dto = array();
    // 结算账户名
    $dto["card_name"] = "圆务铁白事";
    // 银行卡号
...
function get14fb0895D5e649209f1dFd92b764e2fc() {
    $dto = array();
    // 开户固定手续费(元)
    $dto["fee_fix_amt"] = "0";
    // 开户手续费外扣时的账户类型
...
function get8f9e85a652e0414fAd103713b645da7f() {
    $dto = array();
    // 签约人类型
    $dto["type"] = "LEGAL";
    // 签约人手机号
...
function get519dc18aD1c540f88f08856657ba7a6c() {
    $dto = array();
    // 分账接收方汇付ID
    // $dto["huifu_id"] = "test";
    // 分账接收方账户类型
...
function getC25a6c8939df4332A9f7695c956ca304() {
    $dto = array();
    // 分账规则来源
...
function get871acb97D293416e997bB780b95e08fa() {
    $dto = array();
    // 全域资金取现手续费百分比
    // $dto["fee_rate"] = "test";
    // 全域资金取现手续费固定值
...
function getEf903742782b4c6aB775178cfc8f1b7c() {
    $dto = array();
    // 全域资金付款手续费百分比
    // $dto["fee_rate"] = "test";
    // 全域资金付款手续费固定值
...
function getBeee1535242e4a238b0549c9c913c719() {
    $dto = array();
    // 全域资金分账配置开关

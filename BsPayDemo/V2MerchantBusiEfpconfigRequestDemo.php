...
function getExtendInfos() {
    ...
    // 全域资金分账规则
    // $extendInfoMap["efp_spb_config"]= get98526f80E7b24ce5Ba8aFaee6bd73c2b();
    // 客户ip地址
    ...
    // 全域资金取现手续费配置
    // $extendInfoMap["efp_encash_fee_config"]= get470acb0d5dac44ccA85505961c4e64b3();
    // 全域资金付款手续费配置
    // $extendInfoMap["efp_payment_fee_config"]= get74de1e8fA38a428e989dF7622a3c69b2();
    // 纸质协议开始日期
...
function get14520082A0a54613882468ac3d7c7362() {
    $dto = array();
    // 结算账户名
    $dto["card_name"] = "圆务铁白事";
    // 银行卡号
...
function get13968f834e49448a8af0397bd6d4682f() {
    $dto = array();
    // 开户固定手续费(元)
    $dto["fee_fix_amt"] = "0";
    // 开户手续费外扣时的账户类型
...
function getBfd021a17798400893686b61602c1265() {
    $dto = array();
    // 签约人类型
    $dto["type"] = "LEGAL";
    // 签约人手机号
...
function get4b9831faA55c4322931b319719621401() {
    $dto = array();
    // 分账接收方汇付ID
    // $dto["huifu_id"] = "test";
    // 分账接收方账户类型
...
function get98526f80E7b24ce5Ba8aFaee6bd73c2b() {
    $dto = array();
    // 分账规则来源
    ...
    // $dto["rule_detail"] = get4b9831faA55c4322931b319719621401();

    return json_encode($dto,JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES);
}

function get470acb0d5dac44ccA85505961c4e64b3() {
    $dto = array();
    // 全域资金取现手续费百分比
    // $dto["fee_rate"] = "test";
    // 全域资金取现手续费固定值
...
function get74de1e8fA38a428e989dF7622a3c69b2() {
    $dto = array();
    // 全域资金付款手续费百分比
    // $dto["fee_rate"] = "test";
    // 全域资金付款手续费固定值

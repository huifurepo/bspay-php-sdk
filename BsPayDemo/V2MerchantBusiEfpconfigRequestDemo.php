...
function getExtendInfos() {
    ...
    // 全域资金分账规则
    // $extendInfoMap["efp_spb_config"]= getA2e12207739848638dd3552882612d75();
    // 客户ip地址
    ...
    // 全域资金取现手续费配置
    // $extendInfoMap["efp_encash_fee_config"]= getE0e748f9B7ca494680ffA9bef0293827();
    // 全域资金付款手续费配置
    // $extendInfoMap["efp_payment_fee_config"]= getDd50c87c35c0488cB10eF653d41da1be();
    // 纸质协议开始日期
    ...
    // 全域资金分账手续费配置
    // $extendInfoMap["efp_spb_fee_config"]= get565d55c272674b8598a53609129e29ad();
    return $extendInfoMap;
}

function getD0ce9ab0B390402b9fdbF34827a11736() {
    $dto = array();
    // 结算账户名
    $dto["card_name"] = "圆务铁白事";
    // 银行卡号
...
function getFe9977604e1d40c1847b700b9297e703() {
    $dto = array();
    // 开户固定手续费(元)
    $dto["fee_fix_amt"] = "0";
    // 开户手续费外扣时的账户类型
...
function getB753cf982237418290194ab71cae54bc() {
    $dto = array();
    // 签约人类型
    $dto["type"] = "LEGAL";
    // 签约人手机号
...
function get8232c68c5e4c4a61A13f3f0690d5f863() {
    $dto = array();
    // 分账接收方汇付ID
    // $dto["huifu_id"] = "test";
    // 分账接收方账户类型
...
function getA2e12207739848638dd3552882612d75() {
    $dto = array();
    // 分账规则来源
    ...
    // $dto["rule_detail"] = get8232c68c5e4c4a61A13f3f0690d5f863();

    return json_encode($dto,JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES);
}

function getE0e748f9B7ca494680ffA9bef0293827() {
    $dto = array();
    // 全域资金取现手续费百分比
    // $dto["fee_rate"] = "test";
    // 全域资金取现手续费固定值
...
function getDd50c87c35c0488cB10eF653d41da1be() {
    $dto = array();
    // 全域资金付款手续费百分比
    // $dto["fee_rate"] = "test";
    // 全域资金付款手续费固定值
...
function get565d55c272674b8598a53609129e29ad() {
    $dto = array();
    // 全域资金分账配置开关

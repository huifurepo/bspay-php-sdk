...
function getExtendInfos() {
    ...
    // 支付宝扩展参数集合
    $extendInfoMap["alipay_data"]= get527f42f43fb44cd989bfEb5777724789();
    // 微信扩展参数集合
    $extendInfoMap["wx_data"]= get4a37db47Bac14ea8Bae74044392e4787();
    // 商户扩展域
    ...
    // 设备信息
    $extendInfoMap["terminal_device_data"]= get3b9ac7662b374e8fA3c2Ae7552e65384();
    // 异步通知地址
...
function get59cefc6c4a8f4876Ab3f6e88cdf0adfb() {
    $dto = array();
    // 卡类型
    $dto["card_type"] = "";
    // 支付宝点餐场景类型
...
function getEa61a181Bca240f2Ab1f6c561575b036() {
    $dto = array();
    // 商品的编号
...
function get527f42f43fb44cd989bfEb5777724789() {
    $dto = array();
    // 支付宝的店铺编号
    $dto["alipay_store_id"] = "";
    // 业务扩展参数
    $dto["extend_params"] = get59cefc6c4a8f4876Ab3f6e88cdf0adfb();
    // 订单包含的商品列表信息
    $dto["goods_detail"] = getEa61a181Bca240f2Ab1f6c561575b036();
    // 商户操作员编号
...
function getA8112ffd77934b62A480767186e116fa() {
    $dto = array();
    // 商品编码
...
function getCee31279C17b4ef7Acb9Ce293b3b9964() {
    $dto = array();
    // 单品列表
    $dto["goods_detail"] = getA8112ffd77934b62A480767186e116fa();
    // 订单原价
    $dto["cost_price"] = "1";
    // 商品小票ID
    $dto["receipt_id"] = "";
...
function get6e575e922d3e4ff9990aAbca0b4738d5() {
    $dto = array();
    // 门店详细地址
    $dto["address"] = "汇付天下桂林路";
    // 门店行政区划码
...
function getF69c5b2e6abd46a1A1be16c464fd79ce() {
    $dto = array();
    // 门店信息
    $dto["store_info"] = get6e575e922d3e4ff9990aAbca0b4738d5();

    return $dto;
}

function get4a37db47Bac14ea8Bae74044392e4787() {
    $dto = array();
    // 附加数据
    $dto["attach"] = "";
    // 商品详情
    $dto["detail"] = getCee31279C17b4ef7Acb9Ce293b3b9964();
    // 设备号
    $dto["device_info"] = "";
    // 订单优惠标记
    $dto["goods_tag"] = "12321312";
    // 场景信息
    $dto["scene_info"] = getF69c5b2e6abd46a1A1be16c464fd79ce();
    // 子商户公众账号ID
...
function get072323b577db489aAbe28a984765c755() {
    $dto = array();
    // 基站地址
...
function get3b9ac7662b374e8fA3c2Ae7552e65384() {
    $dto = array();
    // 商户终端版本号
    $dto["app_version"] = "";
    // 交易设备GPS

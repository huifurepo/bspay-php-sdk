...
require_once  dirname(__FILE__). "/../BsPaySdk/request/V3TradePaymentScanpayRefundqueryRequest.php";

use BsPaySdk\core\BsPayClient;
use BsPaySdk\request\V3TradePaymentScanpayRefundqueryRequest;

// 2.组装请求参数
$request = new V3TradePaymentScanpayRefundqueryRequest();
// 商户号

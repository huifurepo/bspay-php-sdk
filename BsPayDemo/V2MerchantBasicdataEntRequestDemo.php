...
// 银行卡信息配置
$request->setCardInfo(getDb53ab757bd7482a9e320eba9e624932());
...
function getExtendInfos() {
    ...
    // 受益人列表
    // $extendInfoMap["beneficiary_info"]= getE278ab4672ce4a55B984Cae8d086eab3();
    // 管理员姓名
    ...
    // 结算业务配置
    $extendInfoMap["settle_config"]= getB1067c7008334704Bc1bE66b6125e102();
    // 取现业务配置
    $extendInfoMap["cash_config"]= get272ed8587049485dA5a8B0366e4a7a56();
    // 商户身份
    ...
    // 斗拱e账户功能配置
    // $extendInfoMap["elec_acct_config"]= getBb03824f21e545f6Ba6cF7511b5d8a58();
    // 股东信息
    // $extendInfoMap["share_holder_info_list"]= get6f1b2325295e4941Ba14269eb0fc3303();
    // 扩展资料包
    // $extendInfoMap["extended_material_list"]= get80e5b2d878964f5dAc92Bf39d4fb7031();
    // 产品大类
    // $extendInfoMap["activated_products"]= "";
    return $extendInfoMap;
}

function getE278ab4672ce4a55B984Cae8d086eab3() {
    $dto = array();
    // 受益人名称
    // $dto["bo_name"] = "test";
    // 受益人证件类型
...
function getDb53ab757bd7482a9e320eba9e624932() {
    $dto = array();
    // 银行账户类型
    $dto["card_type"] = "0";
    // 银行账户名
...
function getB1067c7008334704Bc1bE66b6125e102() {
    $dto = array();
    // 结算周期
    $dto["settle_cycle"] = "D1";
...
function get272ed8587049485dA5a8B0366e4a7a56() {
    $dto = array();
...
function getB1480ed011284625B2b05d24d9666703() {
    $dto = array();
    // 银行编码
    // $dto["bank_code"] = "test";
    // 支行联行号
...
function getBb03824f21e545f6Ba6cF7511b5d8a58() {
    $dto = array();
    // 电子账户开关
    ...
    // 银行卡信息
    // $dto["elec_card_list"] = getB1480ed011284625B2b05d24d9666703();
    // 中信签约短信流水号
...
function get6f1b2325295e4941Ba14269eb0fc3303() {
    $dto = array();
    // 股东姓名
    // $dto["name"] = "test";
    // 股东证件类型
...
function get80e5b2d878964f5dAc92Bf39d4fb7031() {
    $dto = array();
    // 文件id
    // $dto["file_id"] = "test";
    // 文件类型

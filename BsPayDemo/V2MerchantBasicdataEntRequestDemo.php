...
function getExtendInfos() {
    ...
    // 受益人列表
    // $extendInfoMap["beneficiary_info"]= get19d6efce7b774a1cB11bCd0b18433828();
    // 联系人姓名
    ...
    // 结算业务配置
    $extendInfoMap["settle_config"]= getD59d298518c64b6dB759D351b65d1f1f();
    // 取现业务配置
    $extendInfoMap["cash_config"]= getD5145881444143dbBfb09d1c2a75ab5c();
    // 商户身份
    ...
    // 斗拱e账户功能配置
    // $extendInfoMap["elec_acct_config"]= get74e1e2070f284e53Aad533e20e2b9307();
    // 股东信息
    // $extendInfoMap["share_holder_info_list"]= get247d97b2203c44e4Bdfa7fb06313af01();
    // 扩展资料包
    // $extendInfoMap["extended_material_list"]= get19825e5d2c6e40f78b402bcde4e3a544();
    return $extendInfoMap;
}

function get19d6efce7b774a1cB11bCd0b18433828() {
    $dto = array();
    // 受益人名称
    // $dto["bo_name"] = "test";
    // 受益人证件类型
...
function get7e5fb98fE68f4c87A99eAccc6898dc1d() {
    $dto = array();
    // 银行账户类型
    $dto["card_type"] = "0";
    // 银行账户名
...
function getD59d298518c64b6dB759D351b65d1f1f() {
    $dto = array();
    // 结算周期
    $dto["settle_cycle"] = "D1";
...
function getD5145881444143dbBfb09d1c2a75ab5c() {
    $dto = array();
...
function getFf2a9cfd5f444044B5197d14ba66ea68() {
    $dto = array();
    // 银行编码
    // $dto["bank_code"] = "test";
    // 支行联行号
...
function get74e1e2070f284e53Aad533e20e2b9307() {
    $dto = array();
    // 电子账户开关
    ...
    // 银行卡信息
    // $dto["elec_card_list"] = getFf2a9cfd5f444044B5197d14ba66ea68();
    // 中信签约短信流水号
...
function get247d97b2203c44e4Bdfa7fb06313af01() {
    $dto = array();
    // 股东姓名
    // $dto["name"] = "test";
    // 股东证件类型
...
function get19825e5d2c6e40f78b402bcde4e3a544() {
    $dto = array();
    // 文件id
    // $dto["file_id"] = "test";
    // 文件类型

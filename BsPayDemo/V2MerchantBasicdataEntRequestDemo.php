...
function getExtendInfos() {
    ...
    // 受益人列表
    // $extendInfoMap["beneficiary_info"]= get65968afa24de4ebbB0712e55f864d1cb();
    // 联系人姓名
    ...
    // 结算业务配置
    $extendInfoMap["settle_config"]= getEba3568c389f430eB5e12de1e6f901dc();
    // 取现业务配置
    $extendInfoMap["cash_config"]= get7e3f9c3516b14b9fA6ec78480141e2cf();
    // 商户身份
    ...
    // 斗拱e账户功能配置
    // $extendInfoMap["elec_acct_config"]= getF77c016709b34cd18e3361c9cbd6dab9();
    // 股东信息
    // $extendInfoMap["share_holder_info_list"]= getF51d351e63aa42d1A496633f45a4baca();
    // 扩展资料包
    // $extendInfoMap["extended_material_list"]= get9aada87c8da74b7cB3a54169d90d2672();
    return $extendInfoMap;
}

function get65968afa24de4ebbB0712e55f864d1cb() {
    $dto = array();
    // 受益人名称
    // $dto["bo_name"] = "test";
    // 受益人证件类型
...
function get08c17ee7B24044da9092F54f82df8595() {
    $dto = array();
    // 银行账户类型
    $dto["card_type"] = "0";
    // 银行账户名
...
function getEba3568c389f430eB5e12de1e6f901dc() {
    $dto = array();
    // 结算周期
    $dto["settle_cycle"] = "D1";
...
function get7e3f9c3516b14b9fA6ec78480141e2cf() {
    $dto = array();
...
function get25f5cfc1A4f14d9a8f7a8b88f1bb829d() {
    $dto = array();
    // 银行编码
    // $dto["bank_code"] = "test";
    // 支行联行号
...
function getF77c016709b34cd18e3361c9cbd6dab9() {
    $dto = array();
    // 电子账户开关
    ...
    // $dto["role_type"] = "test";
    // 银行卡信息
    // $dto["elec_card_list"] = get25f5cfc1A4f14d9a8f7a8b88f1bb829d();

    return json_encode($dto,JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES);
}

function getF51d351e63aa42d1A496633f45a4baca() {
    $dto = array();
    // 股东姓名
    // $dto["name"] = "test";
    // 股东证件类型
...
function get9aada87c8da74b7cB3a54169d90d2672() {
    $dto = array();
    // 文件id
    // $dto["file_id"] = "test";
    // 文件类型

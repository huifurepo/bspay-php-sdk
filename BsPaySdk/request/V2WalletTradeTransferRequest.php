 ...
 * @Description
 */
class V2WalletTradeTransferRequest extends BaseRequest
{
    ...
    public function getInUserHuifuId() {
        return $this->inUserHuifuId;
    }

    public function setInUserHuifuId($inUserHuifuId) {

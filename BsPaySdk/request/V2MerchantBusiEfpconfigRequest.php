...
class V2MerchantBusiEfpconfigRequest extends BaseRequest
{
    ...
    public function getGdCooperationProvePic() {
        return $this->gdCooperationProvePic;
    }

    public function setGdCooperationProvePic($gdCooperationProvePic) {

...
class FunctionCodeEnum
{
     ...
     * 代运营代扣业务配置查询
     */
    static $V2_MERCHANT_BUSI_LLADETAIL = 'v2/merchant/busi/lladetail';
    /**
     * 代运营代扣业务配置
     */
    static $V2_MERCHANT_BUSI_LLACONFIG = 'v2/merchant/busi/llaconfig';
    /**
     * 代运营佣金代扣退款查询
     */
    static $V2_LLA_WITHHOLD_REFUND_QUERY = 'v2/lla/withhold/refund/query';
    /**
     * 代运营佣金代扣退款
     */
    static $V2_LLA_WITHHOLD_REFUND = 'v2/lla/withhold/refund';
    /**
     * 代运营佣金代扣查询
     */
    static $V2_LLA_WITHHOLD_QUERY = 'v2/lla/withhold/query';
    /**
     * 代运营佣金代扣
     */
    static $V2_LLA_WITHHOLD = 'v2/lla/withhold';
    /**
     * 灵工支付退款查询
     */
     ...
     * 电子账户资金清分结果查询
     */
    static $V2_TRADE_SETTLEMENT_CLEARING_QUERY = 'v2/trade/settlement/clearing/query';
    /**
     * 全渠道订单分账明细操作
     */
    static $V2_OCO_ORDER_DETAIL_OPERATE = 'v2/oco/order/detail/operate';
    /**
     * 全渠道订单分账接收方查询
     */
    static $V2_OCO_ORDER_DETAIL_LIST = 'v2/oco/order/detail/list';
    /**
     * 全渠道订单分账计算
     */
    static $V2_OCO_ORDER_CALCULATE = 'v2/oco/order/calculate';
    /**
     * 获取控台页面跳转链接
     */
    static $V2_JUMP_PAGE_GETURL = 'v2/jump/page/geturl';
    /**
     * 全渠道订单分账查询
     */
    static $V2_OCO_ORDER_LIST = 'v2/oco/order/list';
    /**
     * 美团卡券校验
     */
    static $V2_COUPON_MEITUAN_PREPARE = 'v2/coupon/meituan/prepare';
    /**
     * 美团卡券核销结果查询
     */
    static $V2_COUPON_MEITUAN_QUERY = 'v2/coupon/meituan/query';
    /**
     * 美团卡券核销
     */
    static $V2_COUPON_MEITUAN_CONSUME = 'v2/coupon/meituan/consume';
    /**
     * 美团卡券撤销
     */
    static $V2_COUPON_MEITUAN_CANCEL = 'v2/coupon/meituan/cancel';
    /**
     * 美团餐饮门店套餐映射
     */
    static $V2_COUPON_MEAL_QUERY = 'v2/coupon/meal/query';
    /**
     * 三方门店解绑
     */
    static $V2_LINKAPP_STORE_UNBIND = 'v2/linkapp/store/unbind';
    /**
     * 三方门店查询（三方门店绑定一阶段）
     */
    static $V2_LINKAPP_STORE_SHOPLIST = 'v2/linkapp/store/shoplist';
    /**
     * 三方门店绑定（二阶段）
     */
    static $V2_LINKAPP_STORE_BIND = 'v2/linkapp/store/bind';
    /**
     * 门店绑定列表查询
     */
    static $V2_LINKAPP_STORE_QUERY = 'v2/linkapp/store/query';
    /**
     * 美团非餐饮获取团购信息
     */
    static $V2_COUPON_SHOPDEAL_QUERY = 'v2/coupon/shopdeal/query';
    /**
     * 授权结果查询
     */
    static $V2_LINKAPP_AUTH_RESULT = 'v2/linkapp/auth/result';
    /**
     * 商户公域授权
     */
    static $V2_LINKAPP_AUTH_DO = 'v2/linkapp/auth/do';
    /**
     * 查询授权记录
     */
    static $V2_LINKAPP_AUTH_QUERY = 'v2/linkapp/auth/query';
    /**
     * 抖音套餐映射接口
     */
    static $V2_COUPON_DOUYIN_PRODUCT_QUERY = 'v2/coupon/douyin/product/query';
    /**
     * 抖音券状态批量查询
     */
    static $V2_COUPON_DOUYIN_CERTIFICATE_QUERY = 'v2/coupon/douyin/certificate/query';
    /**
     * 抖音卡券校验
     */
    static $V2_COUPON_DOUYIN_PREPARE = 'v2/coupon/douyin/prepare';
    /**
     * 抖音卡券核销
     */
    static $V2_COUPON_DOUYIN_CONSUME = 'v2/coupon/douyin/consume';
    /**
     * 抖音卡券撤销
     */
    static $V2_COUPON_DOUYIN_CANCEL = 'v2/coupon/douyin/cancel';
    /**
     * 银行大额支付固定转账标识申请接口
     */
    static $V2_TRADE_ONLINEPAYMENT_TRANSFER_FIXEDFLAG_APPLY = 'v2/trade/onlinepayment/transfer/fixedflag/apply';
    /**
     * 电子账户付款查询
     */
    static $V2_TRADE_PAYMENT_ZXE_ACCTPYERQUERY = 'v2/trade/payment/zxe/acctpyerquery';
    /**
     * 电子账户付款
     */
    static $V2_TRADE_PAYMENT_ZXE_ACCTPYER = 'v2/trade/payment/zxe/acctpyer';
    /**
     * 银联统一在线收银台签解约查询接口
     */
    static $V2_TRADE_ONLINEPAYMENT_UNIONSIGNQUERY = 'v2/trade/onlinepayment/unionsignquery';
    /**
     * 银联统一在线收银台签约接口
     */
    static $V2_TRADE_ONLINEPAYMENT_UNIONSIGN = 'v2/trade/onlinepayment/unionsign';
    /**
     * 银联统一在线收银台解约接口
     */
    static $V2_TRADE_ONLINEPAYMENT_UNIONCANCEL = 'v2/trade/onlinepayment/unioncancel';
    /**
     * 扫码交易退款
     */
    static $V3_TRADE_PAYMENT_SCANPAY_REFUND = 'v3/trade/payment/scanpay/refund';
    /**
     * 扫码交易退款查询
     */
    static $V3_TRADE_PAYMENT_SCANPAY_REFUNDQUERY = 'v3/trade/payment/scanpay/refundquery';
    /**
     * 扫码交易查询
     */
     ...
     * 聚合反扫
     */
    static $V3_TRADE_PAYMENT_MICROPAY = 'v3/trade/payment/micropay';
    /**
     * 全渠道资金付款到账户退款查询
     */
    static $V2_EFP_ACCTPAYMENT_REFUND_QUERY = 'v2/efp/acctpayment/refund/query';
    /**
     * 全渠道资金付款到账户退款
     */
    static $V2_EFP_ACCTPAYMENT_REFUND = 'v2/efp/acctpayment/refund';
    /**
     * 发票邮件重发接口
     */
    static $V2_INVOICE_RESENDMAIL = 'v2/invoice/resendMail';
    /**
     * 防断链子商户号列表查询
     */
     ...
     * 服务单查询
     */
    static $V2_TRADE_PAYAFTERUSE_CREDITBIZORDER_QUERY = 'v2/trade/payafteruse/creditbizorder/query';
    /**
     * 服务单创建
     */
    static $V2_TRADE_PAYAFTERUSE_CREDITBIZORDER_CREATE = 'v2/trade/payafteruse/creditbizorder/create';
    /**
     * 分期扣款查询
     */
    static $V2_TRADE_PAYAFTERUSE_INSTALLMENT_QUERY = 'v2/trade/payafteruse/installment/query';
    /**
     * 分期扣款
     */
    static $V2_TRADE_PAYAFTERUSE_INSTALLMENT_PAY = 'v2/trade/payafteruse/installment/pay';
    /**
     * 分期交易退款查询
     */
    static $V2_TRADE_PAYAFTERUSE_INSTALLMENT_REFUNDQUERY = 'v2/trade/payafteruse/installment/refundquery';
    /**
     * 分期交易退款
     */
    static $V2_TRADE_PAYAFTERUSE_INSTALLMENT_REFUND = 'v2/trade/payafteruse/installment/refund';
    /**
     * 分期单创建
     */
    static $V2_TRADE_PAYAFTERUSE_INSTALLMENT_CREATE = 'v2/trade/payafteruse/installment/create';

    /**
     * 云MIS订单详情查询接口
     */
    static $V2_TRADE_CLOUDMIS_ORDER_DETAIL = 'v2/trade/cloudmis/order/detail';
    /**
     * 终端云MIS交易
     */
    static $V2_TRADE_CLOUDMIS_DEVICE_INFORMATION_MIS = 'v2/trade/cloudmis/device/information/mis';
    /**
     * 新建付款人
     */
    static $V2_BILL_ENT_PAYER_CREATE = 'v2/bill/ent/payer/create';
    /**
     * 修改付款人信息
     */
    static $V2_BILL_ENT_PAYER_UPDATE = 'v2/bill/ent/payer/update';
    /**
     * 删除付款人
     */
    static $V2_BILL_ENT_PAYER_DELETE = 'v2/bill/ent/payer/delete';
    /**
     * 企业账单状态变更
     */
    static $V2_BILL_ENT_CHANGESTAT = 'v2/bill/ent/changeStat';
    /**
     * 企业账单退款查询
     */
    static $V2_BILL_ENT_REFUND_QUERY = 'v2/bill/ent/refund/query';
    /**
     * 企业账单退款
     */
    static $V2_BILL_ENT_REFUND = 'v2/bill/ent/refund';
    /**
     * 企业账单查询
     */
    static $V2_BILL_ENT_QUERY = 'v2/bill/ent/query';
    /**
     * 付款人查询
     */
    static $V2_BILL_ENT_PAYER_QUERY = 'v2/bill/ent/payer/query';
    /**
     * 创建企业账单
     */
    static $V2_BILL_ENT_CREATE = 'v2/bill/ent/create';
    /**
     * 申诉单详情查询
     */
    static $V2_MERCHANT_APPEAL_DETAIL_QUERY = 'v2/merchant/appeal/detail/query';
    /**
     * 提交申诉
     */
    static $V2_MERCHANT_APPEAL_COMMON_SUBMIT = 'v2/merchant/appeal/common/submit';
    /**
     * 申诉文件url查询
     */
    static $V2_MERCHANT_APPEAL_FILEURL_QUERY = 'v2/merchant/appeal/fileurl/query';
    /**
     * 申诉单列表查询
     */
    static $V2_MERCHANT_APPEAL_LIST_QUERY = 'v2/merchant/appeal/list/query';
    /**
     * 申诉客户信息查询
     */
    static $V2_MERCHANT_APPEAL_CUSTINFO_QUERY = 'v2/merchant/appeal/custinfo/query';
    /**
     * 关联线索查询
     */
    static $V2_MERCHANT_APPEAL_RELATEDCLUE_QUERY = 'v2/merchant/appeal/relatedclue/query';
    /**
     * 操作日志查询
     */
    static $V2_MERCHANT_APPEAL_LOG_QUERY = 'v2/merchant/appeal/log/query';
    /**
     * 快捷绑卡申请接口
     */
    static $V3_QUICKBUCKLE_APPLY = 'v3/quickbuckle/apply';
    /**
     * 快捷绑卡确认接口
     */
    static $V3_QUICKBUCKLE_CONFIRM = 'v3/quickbuckle/confirm';
    /**
     * 新增归集配置
     */
    static $V2_TRADE_SETTLE_COLLECTION_RULE_ADD = 'v2/trade/settle/collection/rule/add';
    /**
     * 修改归集配置
     */
    static $V2_TRADE_SETTLE_COLLECTION_RULE_MODIFY = 'v2/trade/settle/collection/rule/modify';
    /**
     * 归集配置查询
     */
    static $V2_TRADE_SETTLE_COLLECTION_RULE_QUERY = 'v2/trade/settle/collection/rule/query';
    /**
     * 资金归集明细查询
     */
    static $V2_TRADE_SETTLE_COLLECTION_DETAIL_QUERY = 'v2/trade/settle/collection/detail/query';
    /**
     * 灵工微信代发查询
     */
    static $V2_TRADE_LGWX_SURROGATE_QUERY = 'v2/trade/lgwx/surrogate/query';
    /**
     * 灵工微信代发
     */
    static $V2_TRADE_LGWX_SURROGATE = 'v2/trade/lgwx/surrogate';
    /**
     * 银行大额支付解绑
     */
    static $V2_LARGEAMT_BINDCARD_UNBIND = 'v2/largeamt/bindcard/unbind';
    /**
     * 银行大额支付绑卡查询
     */
    static $V2_LARGEAMT_BINDCARD_QUERY = 'v2/largeamt/bindcard/query';
    /**
     * 银行大额支付绑卡
     */
    static $V2_LARGEAMT_BINDCARD_BIND = 'v2/largeamt/bindcard/bind';
    /**
     * 上传短信验证码
     */
    static $V2_INVOICE_MER_VERIFYCODE_UPLOAD = 'v2/invoice/mer/verifycode/upload';
    /**
     * 获取人脸认证二维码
     */
    static $V2_INVOICE_MER_AUTHQRCODE_GRANT = 'v2/invoice/mer/authqrcode/grant';
    /**
     * 查询人脸认证结果
     */
    static $V2_INVOICE_MER_AUTHQRCODE_QUERY = 'v2/invoice/mer/authqrcode/query';
    /**
     * 用户列表查询
     */
    static $V2_USER_LIST_QUERY = 'v2/user/list/query';
    /**
     * 电子发票业务开通查询
     */
     ...
     * 商户注册状态查询
     */
    static $V2_INVOICE_MER_STATUS_QUERY = 'v2/invoice/mer/status/query';
    /**
     * 商户注册信息修改
     */
    static $V2_INVOICE_MER_MODIFY = 'v2/invoice/mer/modify';
    /**
     * 商户注册信息查询
     */
    static $V2_INVOICE_MER_QUERY = 'v2/invoice/mer/query';
    /**
     * 商户注册
     */
     ...
     * 开票员登录
     */
    static $V2_INVOICE_CLERK_LOGON = 'v2/invoice/clerk/logon';
    /**
     * 开票员登记
     */
    static $V2_INVOICE_CLERK_REG = 'v2/invoice/clerk/reg';
    /**
     * 完税凭证下载
     */
